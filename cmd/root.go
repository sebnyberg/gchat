...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.gchat.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".gchat" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".gchat")
	}
